...
class GitHubModelsTranslationGateway
{
    public function __construct(
        protected GitHubModelsClient $client,
    ...
    public function translatePayload(
        ...
        try {
            ...
            $this->safeLogTranslation(
                ...
                jobId: $jobId,
                context: ['provider' => 'github_models'],
            );
        ...
        foreach ($results as $key => $result) {
            ...
            if (isset($result['response']) && is_array($result['response'])) {
                ...
                $this->safeLogTranslation(
                    ...
                    jobId: $jobId,
                    context: array_merge($context, ['provider' => 'github_models']),
                );

                continue;
            }

            $exception = $result['exception'] ?? new RuntimeException('GitHub Models concurrent translation request failed.');
    ...
    {
        return max(1, (int) config('services.github_models.html_parallelism', 2));
    }
