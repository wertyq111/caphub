...
const messages = {
  'zh-CN': {
    ...
    translationProvider: {
      title: '长文本接口切换',
      description: '这里只控制异步长文本和 HTML 任务使用的接口提供方。',
      selectLabel: '长文本接口',
      currentLabel: '当前长文本接口',
      saveAction: '应用切换',
      configured: '已配置',
      notConfigured: '未配置',
      helper: '短纯文本固定走 GitHub Models。这里的切换只影响异步长文本、HTML 和 article payload 任务。',
  ...
  'en-US': {
    ...
    translationProvider: {
      title: 'Long-Form Translation Interface',
      description: 'This selector only controls async long-form and HTML translation jobs.',
      selectLabel: 'Long-form interface',
      currentLabel: 'Current long-form interface',
      saveAction: 'Apply switch',
      configured: 'Configured',
      notConfigured: 'Not configured',
      helper: 'Short plain-text requests are fixed to GitHub Models. This selector only affects async long-form, HTML, and article payload jobs.',
