...
<template>
  <aside class="flex flex-col gap-4">
        ...
        <div class="flex items-start gap-3">
          ...
          <div
            ...
            :class="getAccent(agent) === 'secondary'
              ? 'bg-[rgba(172,137,255,0.15)] text-[var(--np-secondary)]'
          ...
          <div class="min-w-0 flex-1">
            ...
            <div class="mt-3 flex items-center gap-4 text-xs">
              ...
              <div>
                <span class="text-[var(--np-on-surface-variant)]">延迟 </span>
    ...
    <!-- Deploy button -->
    <button class="w-full rounded-[var(--np-radius-lg)] bg-gradient-to-r from-[var(--np-secondary-container)] to-[var(--np-secondary-dim)] px-4 py-3 text-sm font-semibold text-white shadow-[var(--np-glow-secondary)] transition hover:shadow-[var(--np-glow-secondary-strong)]">
      + 部署新代理
    </button>
  </aside>
</template>
